...
Character Classes: A set of characters enclosed in square brackets []. It matches any single character from the set.
...
"""
Alternation: The pipe | symbol is used for alternation, allowing you to match either the pattern on the left or the one on the right.
